...
![CI](https://github.com/step-security/release-drafterr/actions/workflows/ci.yml/badge.svg)


## Usage

You can use the
[Release Drafter GitHub Action](https://github.com/step-security/release-drafterr)
in a
...
steps:
  # runs autolabeler
  - uses: step-security/release-drafter/autolabeler@latest
```
