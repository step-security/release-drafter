...
| `commitish`                | Optional | The release target, i.e. branch or commit SHA it should point to. Defaults to the branch that release-drafter runs for, e.g. `master` when configured to run on pushes to `master`.                                                                     |
